...
- Generated at (UTC): `2026-05-31T23:08:04.039289+00:00`
- Task count: `4`
...
- Path: `artifacts/runs/t_dev_6l_first_run/checkpoints/checkpoint_step_00000010.pt`
- Overall score: `0.0`
- Code score: `0.0`
- Reasoning score: `0.0`
- Matched tasks: `4` / `4`
...
## What was scored
- Local checkpoint samples found under `artifacts/runs/t_dev_6l_first_run/run_artifacts` using patterns `samples/checkpoint_step_*_samples.json, **/samples/checkpoint_step_*_samples.json`.
